---
name: macwdo-python-langgraph-llm-nodes
description: "Macwdo LangGraph LLM-node guidance. Use for ChatOpenAI/BaseChatModel injection, reading state messages, appending model responses immutably, and matching service-node error handling."
---
