---
name: macwdo-typescript-react-state-decision-matrix
description: "Macwdo React state ownership guidance. Use to classify local UI state, validated form state, remote server state, shared client workflow state, and the right tool for each."
---
