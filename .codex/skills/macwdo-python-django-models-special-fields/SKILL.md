---
name: macwdo-python-django-models-special-fields
description: "Macwdo Django model specialized-field guidance. Use for derived @property values, pgvector VectorField embeddings, and deciding when values should or should not be stored."
---
