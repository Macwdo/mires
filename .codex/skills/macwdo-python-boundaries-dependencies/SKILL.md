---
name: macwdo-python-boundaries-dependencies
description: "Macwdo Python boundary and dependency-injection guidance. Use when separating core logic from I/O, external clients, framework adapters, environment access, and global construction."
---
