---
name: macwdo-python-devex-patterns
description: Macwdo's Python developer experience patterns. Use for uv dependency workflows, pyproject configuration, Ruff lint and format rules, pytest async settings, pre-commit hooks, Makefile targets, local setup commands, README run instructions, and keeping tooling consistent with ml-products-grouping.
---
