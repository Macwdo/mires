---
name: macwdo-python-django-serializers-action-aware
description: "Macwdo DRF action-aware serializer guidance. Use for ViewSet get_serializer_class maps, per-action serializers, and differing input/output serializers for one action."
---
