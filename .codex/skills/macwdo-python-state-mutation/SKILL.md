---
name: macwdo-python-state-mutation
description: "Macwdo Python state and mutation guidance. Use when deciding whether functions should return new values, mutate inputs, update shared state, or expose side effects explicitly."
---
