---
name: macwdo-python-django-tests-helpers-fixtures
description: "Macwdo Django helper and fixture guidance. Use for helper-first setup, keyword-only test helpers, sensible defaults, fixtures wrapping helpers, and visible API-driven state creation."
---
