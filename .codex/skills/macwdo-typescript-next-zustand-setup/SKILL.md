---
name: macwdo-typescript-next-zustand-setup
description: "Macwdo Next.js Zustand setup guidance. Use for a small src/stores example store, client-only shared state, selector-friendly stores, and keeping server data in React Query."
---
