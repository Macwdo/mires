---
name: macwdo-python-django-project-bootstrap
description: "Macwdo Django project bootstrap guidance. Use to start a fresh Django backend from Macwdo cookiecutter, prefer HTTPS, fall back to SSH only when needed, and stop after generation."
---
...
- Prefer HTTPS and use `git@github.com:Macwdo/django-cookiecutter-standard.git` only when SSH access is required.
