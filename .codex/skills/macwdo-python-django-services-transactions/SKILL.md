---
name: macwdo-python-django-services-transactions
description: "Macwdo Django service transaction guidance. Use for transaction.atomic, multi-row writes, invariants, transaction.on_commit side effects, and keeping transaction boundaries out of serializers."
---
