---
name: macwdo-python-django-tests-mocking-external-services
description: "Macwdo Django external-service mocking guidance. Use for unittest.mock patching where functions are used, MagicMock, fake clients, and keeping mocks near the test that needs them."
---
