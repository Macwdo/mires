---
name: macwdo-python-django-models-migrations
description: "Macwdo Django model migration guidance. Use after model edits to create and inspect migrations, apply migrations, and update adjacent admin, serializers, selectors, views, services, and tests."
---
