---
name: macwdo-python-functions
description: "Macwdo function-first Python implementation guidance. Use for plain modules, services, transformations, orchestration helpers, and utilities where small typed functions should be preferred over unnecessary classes."
---
