---
name: macwdo-python-django-tests-tdd-workflow
description: "Macwdo Django TDD workflow guidance. Use for red-green-refactor cycles with pytest, DRF, helpers, route names, response assertions, persisted database state, and helper cleanup."
---
