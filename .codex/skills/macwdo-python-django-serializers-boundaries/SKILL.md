---
name: macwdo-python-django-serializers-boundaries
description: "Macwdo DRF serializer boundary guidance. Use for keeping serializers focused on validation and representation, avoiding business writes in create/update/validate, and using context only when necessary."
---
