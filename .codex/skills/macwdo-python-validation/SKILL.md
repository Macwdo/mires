---
name: macwdo-python-validation
description: "Macwdo Python validation guidance. Use for choosing focused pytest, Ruff, format, type-check, and project-specific commands after Python changes."
---
