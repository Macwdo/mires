---
name: macwdo-typescript-react-server-state
description: "Macwdo React server-state guidance. Use for TanStack React Query reads, mutations, query keys, invalidation, staleTime, loading/error states, and keeping fetched data out of Zustand."
---
