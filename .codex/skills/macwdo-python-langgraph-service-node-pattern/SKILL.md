---
name: macwdo-python-langgraph-service-node-pattern
description: "Macwdo canonical LangGraph service-node pattern. Use when implementing the full state, services, node factory, graph setup, and extension pattern for multiple service-backed nodes."
---
