---
name: macwdo-typescript-react-anti-patterns
description: "Macwdo React anti-pattern guidance. Use to avoid caching API responses in Zustand, React Query for local state, manual duplicated zod types, broad stores, and unnecessary form tooling."
---
