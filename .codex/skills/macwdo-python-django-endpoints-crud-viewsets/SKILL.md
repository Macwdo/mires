---
name: macwdo-python-django-endpoints-crud-viewsets
description: "Macwdo DRF CRUD ViewSet guidance. Use for ReadOnlyModelViewSet, GenericViewSet with mixins, create/list/retrieve/update/destroy combinations, and deciding when ModelViewSet is mechanical enough."
---
