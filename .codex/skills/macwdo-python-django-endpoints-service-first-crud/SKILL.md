---
name: macwdo-python-django-endpoints-service-first-crud
description: "Macwdo service-first DRF CRUD guidance. Use when CRUD create/update/destroy logic needs services, selectors, explicit input/output serializers, and overridden ViewSet actions."
---
