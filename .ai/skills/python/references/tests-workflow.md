---
name: tests-workflow
description: "Mires Python testing workflow guidance. Use for behavior-first pytest tests, reading the existing suite, narrow red-green-refactor loops, and focused validation commands."
---
