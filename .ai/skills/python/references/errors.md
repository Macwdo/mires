---
name: errors
description: "Mires Python error-handling guidance. Use for explicit exceptions, readable messages, translating low-level failures at boundaries, and avoiding swallowed errors."
---
