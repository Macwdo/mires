---
name: tests-helpers
description: "Mires Python test helper guidance. Use for visible setup, explicit fixtures, helper functions, monkeypatching, and mocking only true external boundaries."
---
