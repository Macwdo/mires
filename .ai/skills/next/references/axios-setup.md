---
name: axios-setup
description: "Mires Next.js axios setup guidance. Use for a shared src/lib axios instance, centralized base configuration, simple defaults, and avoiding invented interceptors or duplicate clients."
---
