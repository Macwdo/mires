---
name: form-setup
description: "Mires Next.js form setup guidance. Use for a client form example with react-hook-form, zodResolver, schema-first typing, default values, and shadcn form primitives."
---
