...
description: "Mires Next.js project bootstrap guidance. Use to create a new Next app with pnpm, shadcn init, axios, React Hook Form, Zod, resolvers, React Query, and Zustand without manual package edits."
---
