...
description: "Mires Next.js React Query setup guidance. Use for QueryClient provider components, app-root mounting, retry/staleTime defaults, axios query functions, and client provider boundaries."
---
