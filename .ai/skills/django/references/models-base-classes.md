---
name: models-base-classes
description: "Mires Django model base-class guidance. Use for choosing AppBaseModel, AccountRelatedModel, and through-model inheritance in repo-style Django apps."
---
