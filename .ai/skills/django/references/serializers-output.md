---
name: serializers-output
description: "Mires DRF output serializer guidance. Use for ModelSerializer read representations, read_only_fields, explicit response fields, computed outputs, and response-only serializers."
---
