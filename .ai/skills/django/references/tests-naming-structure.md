---
name: tests-naming-structure
description: "Mires Django test naming and file-structure guidance. Use for src/apps/<app>/tests layout, helpers.py, conftest.py, one-line docstrings, and test_resource_action_condition_expected_result names."
---
