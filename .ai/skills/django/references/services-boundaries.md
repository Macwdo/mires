...
description: "Mires Django service boundary guidance. Use for keeping writes in services, reads in selectors, endpoints thin, serializers validation-only, and avoiding business logic in managers, save methods, or signals."
---
