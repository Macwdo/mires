---
name: tests-unauthenticated-api
description: "Mires unauthenticated DRF API test guidance. Use for api_client tests, public versus protected endpoint expectations, 401/403 assertions, and reverse route names."
---
