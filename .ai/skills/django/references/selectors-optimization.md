---
name: selectors-optimization
description: "Mires Django selector optimization guidance. Use for select_related, prefetch_related, annotations, avoiding N+1 serialization, and locating heavy read-path logic in selectors."
---
