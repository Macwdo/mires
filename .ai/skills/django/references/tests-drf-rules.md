---
name: tests-drf-rules
description: "Mires DRF test rules. Use for pytest.mark.django_db, reverse URLs, response body assertions, mutation database assertions, and module-level external-service mocks."
---
