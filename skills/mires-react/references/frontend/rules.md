...
Cross-cutting frontend rules for UI ownership, API integration, and keeping React or Next.js changes aligned with local conventions.
...
- `references/frontend/ui-ownership.md`
