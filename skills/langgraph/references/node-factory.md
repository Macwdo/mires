---
name: node-factory
description: "Mires LangGraph service-node factory guidance. Use for reusable node factories that map state to service inputs, write outputs under a key, clear errors on success, and capture errors on failure."
---
