---
name: client-state
description: "Mires React client-state guidance. Use for focused Zustand stores, shared client-only workflow state, selectors, local component state boundaries, and avoiding broad stores."
---
