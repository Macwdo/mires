...
TypeScript guidance for frontend contracts, API typing, and keeping type ownership aligned with local conventions.
...
- `references/typescript/contracts-and-api-integration.md`
