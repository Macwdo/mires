---
name: tests-forbidden-patterns
description: "Mires Django forbidden test-pattern guidance. Use to avoid factory_boy, model factories, Django fixture files, hardcoded URLs, opaque fixtures, and missing response-body assertions."
---
