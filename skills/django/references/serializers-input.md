---
name: serializers-input
description: "Mires DRF input serializer guidance. Use for request bodies, query params, action payloads, serializers.Serializer validation, field validation, and cross-field validation."
---
