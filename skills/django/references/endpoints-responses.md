---
name: endpoints-responses
description: "Mires DRF response guidance. Use for explicit status codes, public endpoint auth settings, output serialization, object fetching, pagination, filtering, and failure response assertions."
---
