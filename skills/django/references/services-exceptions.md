---
name: services-exceptions
description: "Mires Django service exception guidance. Use for apps.common.exceptions, BussinesLogicException-compatible domain errors, status codes, default_detail, default_code, and caller-friendly messages."
---
