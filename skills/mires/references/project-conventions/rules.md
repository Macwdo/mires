...
Repository convention discovery workflow to inspect existing patterns before backend or framework-specific implementation.
...
- `references/project-conventions/repository-discovery-checklist.md`
