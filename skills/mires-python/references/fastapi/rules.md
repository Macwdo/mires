...
FastAPI patterns for app setup, routes, dependencies, schemas, database access, and worker integration.
...
- `references/fastapi/app-setup.md`
- `references/fastapi/patterns.md`
- `references/fastapi/postgres-connection-setup.md`
- `references/fastapi/celery-integration.md`
