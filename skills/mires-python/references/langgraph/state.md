---
name: state
description: "Mires LangGraph state guidance. Use for TypedDict workflow state, orchestration-only fields, concrete types, error fields, messages, and immutable state updates."
---
