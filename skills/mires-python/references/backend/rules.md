...
Backend architecture and service-layer rules for Python applications after local conventions are inspected.
...
- `references/backend/service-patterns.md`
- `references/backend/settings.md`
- `references/backend/docker-compose-patterns.md`
- `references/backend/docker-compose-local-infra.md`
