...
Celery task, worker, queue, and worker-testing guidance for repositories that already use Celery-style job processing.
...
- `references/celery/celery-app-setup.md`
- `references/celery/celery-testing.md`
- `references/celery/celery-live-worker-testing.md`
