---
name: celery-live-worker-testing
description: Mires's live Celery worker testing pattern for Python and FastAPI workflows. Use when testing actual task execution through delay or apply_async, task registration, serialization, queue routing, worker imports, retries, and database status transitions caused by a real worker and broker.
---
