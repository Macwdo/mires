---
name: tests-authenticated-api
description: "Mires authenticated DRF API test guidance. Use for api_client_with_common_user tests, reverse route names, status and body assertions, and database state assertions after mutations."
---
